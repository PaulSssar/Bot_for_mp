...
class InlineKeyboardButton(MutableTelegramObject):
    ...
    """*Optional*. Data to be sent in a `callback query <    web_app: Optional[WebAppInfo] = None
https://core.telegram.org/bots/api#callbackquery>`_ to the bot when button is pressed, 1-64 bytes"""
